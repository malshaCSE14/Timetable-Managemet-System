...
@section('content')
    <div class="page-title">
        <div class="title_left">
            <h3>Timetable <small>Teacher View</small></h3>
        </div>
    </div>
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                $starttime = "07:30";  // default values, should be able to change
                $endtime = "1:30";
                ...
                <table id="datatable-buttons" class="table table-striped table-bordered">
                    ...
                    <?php
                    for ($period=0; $period<$morning_periods+$evening_periods; $period++){
                    ?>
                    <tr>
                        ...
                        foreach ($days as $day){
                        ?>
                        <td><?php echo $timetable[$day][$period+1]; ?></td>
                        <?php
                        }
                        ?>
                    </tr>
